...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-300 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-r from-yellow-400 to-yellow-600 text-zinc-900 shadow hover:from-yellow-500 hover:to-yellow-700",
        destructive:
          "bg-red-500 text-zinc-50 shadow-sm hover:bg-red-600",
        outline:
          "border border-yellow-400 bg-transparent text-yellow-400 shadow-sm hover:bg-yellow-400/10",
        secondary:
